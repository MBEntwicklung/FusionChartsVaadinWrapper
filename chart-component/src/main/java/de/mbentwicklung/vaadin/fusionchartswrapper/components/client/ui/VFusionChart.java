package de.mbentwicklung.vaadin.fusionchartswrapper.components.client.ui;
 ...
 */
public class VFusionChart extends VEmbedded {
    ...
    private String createFlashEmbed(UIDL uidl) {
        ...
        for (String name : parameters.keySet()) {
            ...
            html.append("value=\"" + parameters.get(name)
                    + "\" ");
            html.append("/>");
        }
        ...
        for (String name : parameters.keySet()) {
            ...
            html.append("=");
            html.append("\"" + parameters.get(name)
                    + "\"");
        }
